...
MASTER_ADDR="/ip4/10.0.20.3/tcp/4001/p2p/$MASTER_ID"
AI_ADDR="/ip4/10.0.20.4/tcp/4001/p2p/$AI_ID"
STORAGE_ADDR="/ip4/10.0.20.11/tcp/4001/p2p/$STORAGE_ID"
ADMIN_ADDR="/ip4/10.0.10.5/tcp/4001/p2p/$ADMIN_ID"
