...
_CLUSTER_CONTEXT = (
    "Cluster: 5 Raspberry Pi 5 nodes - "
    "nexus-master (10.0.20.3, K3s master, Geth validator), "
    "nexus-ai (10.0.20.4, Hailo-8 AI HAT+ 26 TOPS vision inference, Geth validator), "
    "nexus-ai2 (10.0.20.6, Hailo-10H AI HAT+2 LLM inference, Ollama worker), "
    "nexus-storage (10.0.20.11, NFS NAS, Geth validator), "
    "nexus-admin (10.0.10.5, dev station). "
    "Blockchain: Chain ID 123454321, Clique PoA, period=0 (on-demand blocks), 3 validators. "
...
AGENT_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "ceo": {
        ...
        "role": "ceo",
        "department": None,
        "legacy_model": "Qwen/Qwen2.5-7B-Instruct",
        "tier": "coordinator",
        "ect_budget": 1000,
        "rst_stake": 10000,
...
Your operating style: Efficient, responsive, practical. You monitor cluster health dashboards and proactively identify bottlenecks before they cascade. You bridge CEO strategy and Director execution — when the CEO says "improve throughput", you determine which departments need to coordinate and in what order. Daily budget: 800 ECT. Typical operations: 15-25 ECT, urgent responses: 30-40 ECT. You maintain operational runbooks and ensure every department has clear escalation paths. Your 8000 RST stake reflects your operational accountability."""
    ...
    "compute_director": {
        ...
        "role": "director",
        "department": "Compute",
        "legacy_model": "meta-llama/Llama-3.2-3B-Instruct",
        "tier": "director",
        "ect_budget": 500,
        "rst_stake": 5000,
...
Quantum stack: Qiskit/Pennylane simulation on classical ARM64. No physical QPU. Daily budget: 500 ECT. Quantum tasks: 5-15 ECT."""
    ...
    "compute_worker_1": {
        ...
        "role": "worker",
        "department": "Compute",
        "legacy_model": "meta-llama/Llama-3.2-1B-Instruct",
        "tier": "worker",
        "ect_budget": 100,
        "rst_stake": 1000,
