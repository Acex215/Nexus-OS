#!/usr/bin/env python3
"""Deploy TournamentManager contract to NEXUS chain."""
...
# Compile
sol_file = f"{SOURCE_DIR}/TournamentManager.sol"
...
abi_file = f"{SOURCE_DIR}/TournamentManager_sol_TournamentManager.abi"
bin_file = f"{SOURCE_DIR}/TournamentManager_sol_TournamentManager.bin"
...
print("Compiled TournamentManager.sol")
...
with open(f"{DEPLOY_DIR}/TournamentManager.json", 'w') as f:
    json.dump(deploy_info, f, indent=2)

print(f"\nSaved to {DEPLOY_DIR}/TournamentManager.json")
